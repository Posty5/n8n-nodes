...
"@posty5/social-publisher-post": "^2.0.0",
...
7. ✅ **Posty5SocialPublisherPost.node.ts** - Uses SocialPublisherPostClient
...
export const API_ENDPOINTS = {
	...
	TASK: '/api/social-publisher-post',
};
```
...
- [ ] Refactor Posty5SocialPublisherPost.node.ts
